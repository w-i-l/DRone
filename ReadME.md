...
<ol>
    <li>
        ...
        <ul>
            <img src="./ReadMe - images/login.view.png" height="400px">
            <img src="./ReadMe - images/signup.view.png" height="400px">
            <img src="./ReadMe - images/auth.view.png" height="400px">
        </ul>
    ...
    <li>
        ...
        <ul>
            ...
            <img src="./ReadMe - images/weather.verdict.view.png" height="400px">
            <img src="./ReadMe - images/weather.verdict.modal.view.png" height="400px">
        </ul>
        ...
        <ul>
            <img src="./ReadMe - images/weekly.forecast.png" height="400px">
            <img src="./ReadMe - images/change.location.png" height="400px">
        </ul>
    ...
    <li>
        ...
        <ul>
            <img src="./ReadMe - images/map.view.png" height="400px">
            <img src="./ReadMe - images/map.modal.view.png" height="400px">
        </ul>
    ...
    <li>
        ...
        <ul>
            <img src="./ReadMe - images/all.requests.view.png" height="400px">
            <img src="./ReadMe - images/request.info.view.png" height="400px">
            <img src="./ReadMe - images/additional.info.view.png" height="400px">
            <img src="./ReadMe - images/wait.response.view.png" height="400px">
            <img src="./ReadMe - images/notification.view.png" height="400px">
            <img src="./ReadMe - images/request.details.view.png" height="400px">
        </ul>
